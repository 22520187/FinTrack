...
const BalanceCard = ({ balance, income, expense }) => {
  return (
    <Card className="w-full bg-gradient-to-br from-primary-50 to-white">
      <CardHeader className="pb-2">
        <CardDescription className="text-primary-700">Total Balance</CardDescription>
        <CardTitle className="text-3xl font-bold text-primary-800">${balance.toFixed(2)}</CardTitle>
      </CardHeader>
      <CardContent>
